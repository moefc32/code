        ...
        <div class="flex flex-wrap justify-center items-center -mx-2">
            {#if !dataLoading}
                {#each discord as item, i}
                    <div
                        class="mt-4 px-2 w-full sm:w-1/2 md:w-1/3 lg:w-1/4"
                        data-aos="fade-up"
                    >
                        <div
                            class="card flex flex-row items-center gap-3 px-4 w-full h-[70px] border-1 border-gray-300 shadow-lg"
                            title={item.name}
                        >
                            <div
                                class="bg-contain! w-[45px] aspect-square rounded-full border-1 border-gray-300"
